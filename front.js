$(document).ready(function () {
    ...
    var shopUrl = "https://cors-anywhere.herokuapp.com/" + "http://open.api.ebay.com/shopping?callname=FindProducts&responseencoding=JSON&appid=" + appId + "&siteid=0&version=967&QueryKeywords=" + itemName + "&AvailableItemsOnly=true&MaxEntries=2";
    ...
    var merchantUrl = "https://cors-anywhere.herokuapp.com/" + "http://svcs.ebay.com/MerchandisingService?OPERATION-NAME=getSimilarItems&SERVICE-NAME=MerchandisingService&SERVICE-VERSION=1.1.0&CONSUMER-ID=" + appId + "&RESPONSE-DATA-FORMAT=JSON&REST-PAYLOAD&itemId=" + itemId + "&maxResults=3";
